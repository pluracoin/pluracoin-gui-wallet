...
const QString BITCOIN_IPC_PREFIX("pluracoin:");

static QString ipcServerName()
{
    QString name("PluraCoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start pluracoin: click-to-pay handler");
    else
...
{
    // clicking on pluracoin: URLs creates FileOpen events on the Mac:
