...
set(WALLET_NAME "PluraCoinWallet")
set(CN_CURRENCY_DISPLAY_NAME "PLURA")
...
if(GIT_FOUND)
  ...
  if(NOT WALLET_GIT_RESULT EQUAL 0)
    set(WALLET_GIT_TAG "1.2.0")
	set(WALLET_VER_MAJOR 1)
	set(WALLET_VER_MINOR 2)
...
set(WALLET_VENDOR_NAME "PluraCoin Developers")
set(WALLET_COPYRIGHT "Copyright 2016-2023 ${PROJECT_VENDOR_NAME}")
set(WALLET_VENDOR_URL "https://pluracoin.org")
