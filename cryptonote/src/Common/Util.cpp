...
std::string get_nix_version_display_string()
{
  ...
  std::string getDefaultDataDirectory()
  {
...
#ifdef WIN32
    // Windows
    config_folder = get_special_folder_path(CSIDL_APPDATA, true) + "/" + CryptoNote::CRYPTONOTE_NAME + CryptoNote::CRYPTONOTE_INTVERSION;
#else
    std::string pathRet;
    ...
    config_folder =  (pathRet + "/" + CryptoNote::CRYPTONOTE_NAME + CryptoNote::CRYPTONOTE_INTVERSION);
#else
    // Unix
    config_folder = (pathRet + "/." + CryptoNote::CRYPTONOTE_NAME + CryptoNote::CRYPTONOTE_INTVERSION);
#endif
